...
class SearchFirstPageLoader(
    ...
    override suspend fun load(): PhotoLoaderResponse {
        ...
        val response = apolloClient.query(SearchPhotoQuery(SearchArgUtil.query(inputData) ?: "", 1)).execute()
...
class SearchNextPageLoader(
    ...
    override suspend fun load(page: Int): PhotoLoaderResponse {
        val resp = apolloClient.query(SearchPhotoQuery(SearchArgUtil.query(inputData) ?: "", page)).execute()
